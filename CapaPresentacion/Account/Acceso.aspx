...
<html class="bg-blue-gradient" xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
...
<body class="hold-transition login-page bg-blue-gradient">
    ...
    <div class="form-box" id="login-box">        
        <form id="form1" runat="server">
            <div class="header">
                <img src="../img/logo.png" style="height: 90px; width: 200px;" />
            <%--<strong>Inicio de Sesión</strong>--%>
        </div>
            <div class="body">
                <div class="form-group has-feedback">
                    <asp:TextBox ID="TextBoxUsuario" runat="server" CssClass="form-control bg-gray" placeholder="Email ..." ToolTip="Ingresa un eMail Valido" TextMode="Email" required autofocus></asp:TextBox>
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <asp:TextBox ID="TextBoxContrasena" runat="server" CssClass="form-control bg-gray" placeholder="Contraseña ..." TextMode="Password" ToolTip="Ingresa una contraseña" required autofocus></asp:TextBox>
            ...
            <div class="footer">
                ...
                <p class="text-center text-muted text-uppercase">Powered By eImagen</p>
            </div>
        </form>
    </div>
