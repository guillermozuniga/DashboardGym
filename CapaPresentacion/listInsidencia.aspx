<%@ Page Title="Lista Insidencias" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterDefault.Master" CodeBehind="listInsidencia.aspx.vb" Inherits="CapaPresentacion.listInsidencia" %>
    ...
    <div class="row" id="ListaAlumnos" runat="server" visible="false">
        <div class="col-md-12">
            <div class="panel panel-default">
                    ...
                    <h4 class="panel-title">Información de Insidencias</h4>
                </div>
                <div class="panel-body">
                    
                    <asp:GridView ID="GvAlum" CssClass="table table-bordered" AutoGenerateColumns="False"
                        AllowPaging="True" PageSize="25" EmptyDataText="No hay registros para mostrar." runat="server" EnablePersistedSelection="True" DataKeyNames="Alumnos_Matricula">
                ...
                <div class="panel-body">
                    ...
                    <div class="scrolling-table-container">
                        <asp:GridView ID="gvInsidencias" CssClass="table table-bordered" AutoGenerateColumns="false"
                            AllowPaging="true" PageSize="10" EmptyDataText="No hay registros para mostrar." runat="server" DataKeyNames="Cargos_Id">
                            <AlternatingRowStyle BackColor="WhiteSmoke" ForeColor="#284775" />
                            <Columns>
