...
Public Class frmCajero7
#Region "Declaraciones"
    Friend _Causa As String = String.Empty
...
#End Region
    ...
    Private Sub ButtonIntentar_Click(sender As Object, e As EventArgs) Handles ButtonIntentar.Click

    End Sub

    Private Sub frmCajero7_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Label3.Text = _Causa
